...
public class Camioneta extends Vehiculo{
    ...
    public Camioneta(String placa, String marca, String motor, int anio, double recorrido, String color, String combustible, double precio, String transmision, int vidrios) {
